...
const explorersInNodeAndFizzBuzzAndOtherTrick = explorersInNode.map((explorer) => assignFizzBuzzAndOtherTrick(explorer));
console.log(explorersInNodeAndFizzBuzzAndOtherTrick)